  ...
  notesSidebar: [
    ...
    // ════════ 0 · Python for AI (the minimum you need) ════════
    {
      ...
      items: [
        ...
        soon("Pydantic (data validation & structured outputs)"),
    ...
    // ════════ 4 · Retrieval (RAG) — LIVE (currently studying) ════════
    {
      ...
      items: [
        ...
        "rag-course/15-agents-architecture",
        "rag-course/16-agentic-rag",
        ...
        "rag-course/19-corrective-rag",
        "rag-course/20-adaptive-rag",
        soon("21 · RAG with Persistent Memory"),
        soon("22 · Cache RAG with LangGraph"),
        soon("23 · VectorLess RAG with PageIndex"),
        "rag-course/24-guardrails",
        "rag-course/25-llm-gateways",
        "rag-course/26-evaluation",
    ...
    // ════════ 7 · Agentic AI ════════
    {
      ...
      items: [
        ...
        project("Agentic Chatbot (LangGraph + LangSmith + RAG + HITL)", "intermediate"),
        project("TripMate AI — Multi-Agent Travel Planner", "intermediate"),
      ],
    },
    ...
    // ════════ 8 · AgentOps, MCP & Production ════════
    {
      ...
      items: [
        ...
        project("Multi-Agent AI with MCP + Supervisor + Guardrails", "advanced"),
        project("Self-Correcting Multi-Agent App (DigitalOcean)", "intermediate"),
